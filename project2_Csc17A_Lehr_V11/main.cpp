/*
    ...
    Purpose:Project Two - Blackjack
            V11 - Adding STL, sorting hands at the finish of the program for
            players to see the least to greatest hand of players 1-4. Also, 
            incorporating a template to show the largest bet.
 */
...
int main(int argc, char** argv) {
    ...
    cout << "\nThe largest bet/winnings made in today's game was $" 
         << bigBet.bigger();
